...
<div class="container-fluid">
   <div class="page-header">
      <div class="row">
         <div class="col-lg-6">
            <h3>Dokumen {{ $document_asli->name }}</h3>
         </div>
         <div class="col-lg-6">
            <ol class="breadcrumb pull-right">
               <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="fa fa-home"></i></a></li>
               <li class="breadcrumb-item"><a href="{{ route('dashboard.detail_materi.create', [
                  'slug' => $document_asli->training->slug,
                  'year' => $document_asli->training->year,
                  'month' => $document_asli->training->month,
                  'jenis' => 'document'
               ]) }}">Detail Materi</a></li>
               <li class="breadcrumb-item active">Detail Dokumen Pelatihan</li>
            </ol>
         </div>
      </div>
   </div>
   ...
   <div class="col-sm-12">
      <div class="card">
         <div class="card-header">
            <h5>Data Dokumen {{ $document_asli->name }}</h5>
                  ...
                  <table class="table table-hover">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{ $value->type }}</td>
                           <td>
                              <form action="{{ route('destroy.document.detail', $value->id) }}" method="post" id="form-{{ $value->id }}">
                                 @csrf
                                 @method("DELETE")
                                    <a href="{{ route('edit.document.detail', $value->id) }}" class="btn btn-secondary"><i class="fa fa-edit"></i></a>
                                    <a href="{{ route('document.subdetail.show', $value->id) }}" class="btn btn-warning"><i class="fa fa-plus"></i></a>
...
<div class="modal fade" id="modalData" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('document.detail.store', $id) }}" method="post">
               @csrf
                  ...
                  <div class="row">
                     <div class="col-xl-12">
                        <div class="form-group">
                           ...
                           <input name="type" type="text" class="form-control form-control-user @error('type') is-invalid @enderror" placeholder="Tipe" required>
                           @error('type')
