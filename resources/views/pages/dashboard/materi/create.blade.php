            ...
            <div class="col-sm-12 col-lg-12 col-xl-12">
               <form action="{{ route('dashboard.materi.store') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" name="start" class="form-control digits @error('start') is-invalid @enderror" id="startDate" value="{{ old('start') }}">
                           @error('start')
                              <span class="invalid-feedback" role="alert">
                                 <strong>{{ $message }}</strong>
                              </span>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" name="end" class="form-control digits disabled @error('end') is-invalid @enderror" id="endDate" disabled value="{{ old('end') }}">
                           @error('end')
                              <span class="invalid-feedback" role="alert">
                                 <strong>{{ $message }}</strong>
                              </span>
                  ...
                  <div class="form-group">
                     ...
                     <textarea name="description2" class="form-control @error('description2') is-invalid @enderror">{{ old('description2') }}</textarea>
                     @error('description2')
                        <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                        </span>
